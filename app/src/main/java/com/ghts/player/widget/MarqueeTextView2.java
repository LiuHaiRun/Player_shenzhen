 ...
 */
public class MarqueeTextView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    class MyRunnable implements Runnable {
        ...
        public void run() {
            //整个空间的宽度
            mWidth = MarqueeTextView2.this.getWidth();
            mScrollRect = new Rect(0, 0, MarqueeTextView2.this.getWidth(), MarqueeTextView2.this.getHeight());
                ...
                try {
                    synchronized (holder) {
                        ...
                        if (ret == 1) {
                            ...
                            paint = null;
                            currentScrollX = MarqueeTextView2.this.getWidth();
                            textWidth = 0;
        ...
        private int draw() {
            ...
            if ((currentScrollX + textWidth + scroll_space) <= mWidth) {
                if (textWidth >= mWidth * 5) {//超过一定长度,不再追加currentText
        ...
        public void initPaint() {
            ...
            initFont(paint, font);
            y_pos = MarqueeTextView2.this.getHeight() - (MarqueeTextView2.this.getHeight() - font.getSize()) / 2;
        }
