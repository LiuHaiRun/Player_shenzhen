...
/**
 * Created by lijingjing on 17-8-30.
 * 重写水平滚动条
 */
public class ScrollView extends BaseModuleInfo {
    private static final String TAG = "ScrollView";
    private MarqueeTextView mScroll;
    ...
    public View getView(Context context) {
        mContext = context;
        mScroll = new MarqueeTextView(context);
        //设置控件基本属性
     ...
     * 接收数据库发送的紧急模板的文件指令
     */
    public void receiveControlCmd(ArrayList<String> dbstr) {
        text_list = new ArrayList<String>();
        text_list.clear();
        text_list = dbstr;
        setText_list(text_list);
